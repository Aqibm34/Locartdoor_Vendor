...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
    ...
    public MyAdapter(Context context, ArrayList<String> status, ArrayList<String> orderId,ArrayList<String> location, ArrayList<String> time,ArrayList<String> date, ArrayList<String> items,ArrayList<String> price, ArrayList<String> arriveTime) {
